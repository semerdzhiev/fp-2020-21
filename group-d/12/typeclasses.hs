...
-- Напишете FizzBuzz задачата
-- Връща първите n числа, като за всяко число:
-- Ако се дели на 3 се замества с Fizz
-- Ако се дели на 5 се замества с Buzz
-- АКо се дели на 15 (т.е. и на 2те) се замества с FizzBuzz
-- Всички останали числа остават непроменени
